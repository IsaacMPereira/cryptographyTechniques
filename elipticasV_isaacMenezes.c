 ...
 *
 * Compile: $ gcc -Wall elipticasV_isaacMenezes.c -lgmp -o elipticas_isaacMenezes.x 
...
void generatingPoints(int a, int b, int p, int n){
	...
	fileError(file1, "Error on openning pointsElliptics.dat in 'w' mode in generatingPoints()");
...
void choosingPoints(int n, int a, int p){
	...
	fileError(file2, "Error on openning pointsElliptics.dat in 'r' mode in choosingPoints()");

	FILE *file3 = fopen("choosedPoints_ellipticCurve.dat", "w");
	fileError(file3, "Error on openning choosedPoints_ellipticCurve.dat in 'w' mode in choosingPoints()");
...
void findOrder(int a, int p){
	...
	fileError(file5, "Error on openning choosedPoints_ellipticCurve.dat in 'r' mode in findOrder()");

	FILE *file6 = fopen("2choosedPoints_ellipticCurve.dat", "w");
	fileError(file6, "Error on openning 2choosedPoints_ellipticCurve.dat in 'w' mode in findOrder()");

	FILE *file7 = fopen("orders.dat", "w");
	fileError(file7, "Error on openning orders.dat in 'w' mode in findOrder()");
